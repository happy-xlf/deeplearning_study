...
json_example = {'edges': [{'data': {'color': '#FFA07A',
                ...
                'nodes': [{'data': {'color': '#FFC0CB', 'id': 'source 1', 'label': 'source 1'}},
                          {'data': {'color': '#90EE90', 'id': 'source 2', 'label': 'source 2'}},
                          {'data': {'color': '#87CEEB', 'id': 'source 3', 'label': 'source 3'}}]}
...
def generate_graph_info(raw_text: str) -> str:
    ...
    graph_info_result = client.chat.completions.create(
        messages=messages,
        model='qwen2.5:7b',
